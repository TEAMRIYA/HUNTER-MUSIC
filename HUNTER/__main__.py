...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("HUNTER.plugins" + all_module)
    LOGGER("HUNTER.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await Anony.start()
    try:
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("HUNTER").info("Stopping HUNTER Bot...")
